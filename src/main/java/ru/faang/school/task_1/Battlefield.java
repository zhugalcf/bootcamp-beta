...
public class Battlefield {
    ...
    public Hero battle(){
        ...
        double speedCoefficient = (hero1.getArmySpeed() / hero2.getArmySpeed());  /*коэффициент скорости,
        ...
        System.out.println(hero1.getArmyPower());
        System.out.println(hero2.getArmyDefence());
        System.out.println(speedCoefficient);
        System.out.println(hero1Coefficient);
        System.out.println(hero2Coefficient);
